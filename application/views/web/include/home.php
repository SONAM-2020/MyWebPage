  ...
  <div class="container">
    <div class="row">
      ...
      <article class="col-md-4 col-sm-6 col-xs-12 clearfix ">
        <div class="post-item">
          <div class="media-wrapper">
            <img src="<?php echo base_url();?>/assest/web/images/blog/post-1.jpg" alt="amazing caves coverimage" class="img-fluid">
          </div>
      ...
      <article class="col-md-4 col-sm-6 col-xs-12 ">
        <div class="post-item">
          <div class="media-wrapper">
            <img src="<?php echo base_url();?>/assest/web/images/blog/post-2.jpg" alt="amazing caves coverimage" class="img-fluid">
          </div>
      ...
      <article class="col-md-4 col-sm-6 col-xs-12 ">
        <div class="post-item">
          <div class="media-wrapper">
            <img src="<?php echo base_url();?>/assest/web/images/blog/post-3.jpg" alt="amazing caves coverimage" class="img-fluid">
          </div>
